...
def write_resume_template(resume_name: str, title: str) -> str:
    ...
    return (
        ...
        f"**{title}**\n\n"
        "## Summary\n"
        "- Role-focused summary in 2-3 lines with one measurable outcome.\n\n"
        "## Work Experience\n"
        "### Company | Title | YYYY-MM to YYYY-MM\n"
        "- Action + scope + measurable result (for example: reduced cost 18%).\n"
        "- Use concrete tools, systems, and domain terms naturally.\n\n"
        "## Skills\n"
        "- Skill 1 (Acronym and Full Term)\n"
        "- Skill 2\n\n"
        "## Education\n"
        "- Degree, School, Year\n\n"
        "## Languages\n"
